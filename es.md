...
它是以文档作为最小存储单元的形式来存储的。

indices--->document  (json)
...
### 4.1.将文档内容分词，所有不重复的词组成分词列表

 lucene的底层有一个分词器



### 4.2.将文档最终以document方式存储起来



### 4.3.每个词和document都有关联
